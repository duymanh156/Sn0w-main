...
public class PistonKick extends Module {
    
    public static PistonKick INSTANCE;
    ...
    public void onUpdate(final TickEvent.PlayerTickEvent.Pre event) {
        ...
        {
            ChatUtils.sendMessage("[PistonKick] You don't have the required items in your hotbar!");
            this.toggle();
            return;
        }
    ...
    {
        return "PistonKick: Kicks people out of their safe holes using pistons";
    }
}